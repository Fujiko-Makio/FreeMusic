...
# 概要・制作背景
### 自身の動画作成経験、音楽活動経験を通して楽曲やBGMなど利用する際に簡単に検索でき、購入やダウンロードをしやすいアプリケーションの開発したかった。また楽曲を利用するユーザー、提供する作曲家のユーザー双方にメリットがあるサービスを提供したいと考えた。
### コロナ禍の影響により既存の音楽制作活動に支障をきたしている作曲家へ新たな認知を得るきっかけ作りに貢献したい。
### 在宅ワークなどで家で過ごす時間が増えたユーザーのクリエイティブな活動に利用できる。
## ユーザー
